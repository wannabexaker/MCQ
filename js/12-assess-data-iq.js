...
const IQ_RESULT_TEXTS = {
  ...
  limitations_en: "How to read this: this is a 20-item, unnormed practice test scored against assumed item difficulties — not a clinical or professionally administered IQ test. The estimate carries an uncertainty of at least ±7 points (that's why a range is shown), skipped items count as incorrect, percentiles are rounded, and scores are deliberately pulled slightly toward 100 to reflect the test's limited reliability. Treat the result as an indication for entertainment and self-exploration, nothing more.",
  limitations_el: "Πώς να το διαβάσεις: πρόκειται για τεστ εξάσκησης 20 ερωτήσεων, χωρίς στάθμιση, που βαθμολογείται με υποτιθέμενες δυσκολίες ερωτήσεων — όχι για κλινικό ή επαγγελματικά χορηγούμενο τεστ IQ. Η εκτίμηση έχει αβεβαιότητα τουλάχιστον ±7 μονάδων (γι' αυτό εμφανίζεται εύρος), οι παραλειφθείσες ερωτήσεις μετρούν ως λάθος, τα εκατοστημόρια στρογγυλοποιούνται και τα σκορ έλκονται σκόπιμα ελαφρά προς το 100, αντανακλώντας την περιορισμένη αξιοπιστία του τεστ. Αντιμετώπισε το αποτέλεσμα ως ένδειξη για ψυχαγωγία και αυτοδιερεύνηση, τίποτα παραπάνω.",
};

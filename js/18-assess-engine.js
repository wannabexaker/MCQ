...
const ASSESS_I18N = {
  en: {
    ...
    submit: "✓ Submit",
    exitToHub: "✕ Save & exit",
    noRightAnswers: "Rate how much you agree that each statement describes you — there are no right or wrong answers.",
    ...
    rawScore: "Raw score",
    anPercentile: "Estimated standing: ahead of ~{p}% of test-takers",
  ...
  el: {
    ...
    noRightAnswers: "Δήλωσε πόσο συμφωνείς ότι κάθε πρόταση σε περιγράφει — δεν υπάρχουν σωστές ή λάθος απαντήσεις.",
    ...
    rawScore: "Σκορ",
    anPercentile: "Εκτιμώμενη θέση: μπροστά από ~{p}% όσων κάνουν το τεστ",
    ...
    archetypeLabel: "ΤΟ ΑΡΧΕΤΥΠΟ ΣΟΥ",
    ...
    exportFail: "Δεν ήταν δυνατή η δημιουργία του αρχείου.",
...
const ASSESS_TESTS = {
  ...
  analytical: {
    ...
    fromStored: (s) => ({ raw: s.raw, areas: s.areas || null, bandIndex: analyticalBandIndex(s.raw), percentile: analyticalPercentile(s.raw) }),

...
const SD3_ITEMS = [
  { id: "sd3-n1", trait: "N", reverse: false,
    ...
    text_el: "Αναλαμβάνω φυσικά τα ηνία όταν είμαι μέλος μιας ομάδας." },
  ...
  { id: "sd3-p1", trait: "P", reverse: false,
    ...
    text_el: "Λέω αυτό που σκέφτομαι ακόμα κι όταν πληγώνει." },
  ...
  { id: "sd3-p5", trait: "P", reverse: false,
    ...
    text_el: "Βαριέμαι γρήγορα και χρειάζομαι συνεχώς ένταση." },
  ...
  { id: "sd3-m6", trait: "M", reverse: false,
    ...
    text_el: "Είναι σοφό να θυμάσαι τις χάρες που σου χρωστούν." },
  ...
  { id: "sd3-m8", trait: "M", reverse: false,
    text_en: "Playing the long game pays better than chasing quick wins.",
    text_el: "Το μακροπρόθεσμο παιχνίδι αποδίδει περισσότερο από το κυνήγι γρήγορων κερδών." },
  { id: "sd3-p8", trait: "P", reverse: true,
    text_en: "I have never gotten into trouble with any kind of authority.",
    text_el: "Δεν έχω μπλέξει ποτέ με καμία μορφή εξουσίας." },

  { id: "sd3-n9", trait: "N", reverse: false,
    text_en: "My opinion usually carries more weight than other people's.",
    text_el: "Η γνώμη μου συνήθως μετράει περισσότερο από των άλλων." },
  ...
  { id: "sd3-p9", trait: "P", reverse: false,
    text_en: "Other people's problems are their own to solve.",
    text_el: "Τα προβλήματα των άλλων είναι δική τους υπόθεση να τα λύσουν." },
];
